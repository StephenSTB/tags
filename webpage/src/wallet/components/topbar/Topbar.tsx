...
export const Topbar = (props: TopbarProps) =>{
    ...
    return(
        <div id="topbar">
            <div id="center">
                <Button size="small" id="topbar-name-button" text="Name" onClick={() => props.setComp("Name")}/>
                <Button size="small" id="topbar-message-button" text="Message" onClick={() => props.setComp("Message")}/>
